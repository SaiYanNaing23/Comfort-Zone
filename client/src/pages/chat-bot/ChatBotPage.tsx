  ...
  return (
    <div className="min-h-screen bg-zinc-900/90 rounded-md text-white font-bold p-5 " >
      <div className="chat chat-end">
        ...
        <div className="chat-bubble">What is Spotify?</div>
      </div>
