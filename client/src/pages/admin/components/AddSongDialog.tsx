        ...
        <Dialog open={songDialogOpen} onOpenChange={setSongDialogOpen} >
            ...
            <DialogContent className="bg-zinc-900 border-zinc-700 max-h-[80vh] overflow-auto " >
                ...
                <div className="space-y-4 py-4" >
                    ...
                    {/* image upload area */}
                    <div
						className='flex items-center justify-center p-6 border-2 border-dashed border-zinc-700 hover:border-emerald-900/50 rounded-lg cursor-pointer'
            ...
            <DialogFooter>
                <Button variant='outline' onClick={() => setSongDialogOpen(false)} disabled={isSubmitting}>
                    Cancel
                </Button>
